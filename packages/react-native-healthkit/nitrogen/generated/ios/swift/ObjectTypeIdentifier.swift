...
/**
 * Represents the JS union `ObjectTypeIdentifier`, backed by a C++ enum.
 */
public typealias ObjectTypeIdentifier = margelo.nitro.healthkit.ObjectTypeIdentifier

public extension ObjectTypeIdentifier {
  /**
   * Get a ObjectTypeIdentifier for the given String value, or
  ...
  init?(fromString string: String) {
    switch string {
      ...
      case "HKCharacteristicTypeIdentifierBiologicalSex":
        self = .hkcharacteristictypeidentifierbiologicalsex
      case "HKCharacteristicTypeIdentifierBloodType":
        self = .hkcharacteristictypeidentifierbloodtype
      case "HKCharacteristicTypeIdentifierDateOfBirth":
        self = .hkcharacteristictypeidentifierdateofbirth
      case "HKCharacteristicTypeIdentifierWheelchairUse":
        self = .hkcharacteristictypeidentifierwheelchairuse
      case "HKCharacteristicTypeIdentifierActivityMoveMode":
        self = .hkcharacteristictypeidentifieractivitymovemode
  ...
  /**
   * Get the String value this ObjectTypeIdentifier represents.
   */
