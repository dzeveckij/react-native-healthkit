///
/// SampleTypeIdentifierWriteable.swift
...
/**
 * Represents the JS union `SampleTypeIdentifierWriteable`, backed by a C++ enum.
 */
public typealias SampleTypeIdentifierWriteable = margelo.nitro.healthkit.SampleTypeIdentifierWriteable

public extension SampleTypeIdentifierWriteable {
  /**
   * Get a SampleTypeIdentifierWriteable for the given String value, or
  ...
  /**
   * Get the String value this SampleTypeIdentifierWriteable represents.
   */
