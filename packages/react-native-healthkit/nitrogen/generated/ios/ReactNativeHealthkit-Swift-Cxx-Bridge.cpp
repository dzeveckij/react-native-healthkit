...
namespace margelo::nitro::healthkit::bridge::swift {
  ...
  Func_void_std__vector_ClinicalRecord_ create_Func_void_std__vector_ClinicalRecord_(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_std__vector_ClinicalRecord_::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const std::vector<ClinicalRecord>& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  Func_void_ClinicalRecordsWithAnchorResponse create_Func_void_ClinicalRecordsWithAnchorResponse(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_ClinicalRecordsWithAnchorResponse::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const ClinicalRecordsWithAnchorResponse& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  std::shared_ptr<HybridClinicalRecordsModuleSpec> create_std__shared_ptr_HybridClinicalRecordsModuleSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    ReactNativeHealthkit::HybridClinicalRecordsModuleSpec_cxx swiftPart = ReactNativeHealthkit::HybridClinicalRecordsModuleSpec_cxx::fromUnsafe(swiftUnsafePointer);
    return std::make_shared<margelo::nitro::healthkit::HybridClinicalRecordsModuleSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridClinicalRecordsModuleSpec_(std__shared_ptr_HybridClinicalRecordsModuleSpec_ cppType) {
    std::shared_ptr<margelo::nitro::healthkit::HybridClinicalRecordsModuleSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::healthkit::HybridClinicalRecordsModuleSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridClinicalRecordsModuleSpec\" is not implemented in Swift!");
    }
    #endif
    ReactNativeHealthkit::HybridClinicalRecordsModuleSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  Func_void_QueryCorrelationSamplesWithAnchorResponse create_Func_void_QueryCorrelationSamplesWithAnchorResponse(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_QueryCorrelationSamplesWithAnchorResponse::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const QueryCorrelationSamplesWithAnchorResponse& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  Func_void_std__vector_UserAnnotatedMedication_ create_Func_void_std__vector_UserAnnotatedMedication_(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_std__vector_UserAnnotatedMedication_::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const std::vector<UserAnnotatedMedication>& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  Func_void_std__vector_MedicationDoseEvent_ create_Func_void_std__vector_MedicationDoseEvent_(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_std__vector_MedicationDoseEvent_::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const std::vector<MedicationDoseEvent>& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  Func_void_MedicationDoseEventsWithAnchorResponse create_Func_void_MedicationDoseEventsWithAnchorResponse(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_MedicationDoseEventsWithAnchorResponse::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const MedicationDoseEventsWithAnchorResponse& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
  ...
  std::shared_ptr<HybridMedicationModuleSpec> create_std__shared_ptr_HybridMedicationModuleSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    ReactNativeHealthkit::HybridMedicationModuleSpec_cxx swiftPart = ReactNativeHealthkit::HybridMedicationModuleSpec_cxx::fromUnsafe(swiftUnsafePointer);
    return std::make_shared<margelo::nitro::healthkit::HybridMedicationModuleSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridMedicationModuleSpec_(std__shared_ptr_HybridMedicationModuleSpec_ cppType) {
    std::shared_ptr<margelo::nitro::healthkit::HybridMedicationModuleSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::healthkit::HybridMedicationModuleSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridMedicationModuleSpec\" is not implemented in Swift!");
    }
    #endif
    ReactNativeHealthkit::HybridMedicationModuleSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
  ...
  Func_void_StateOfMindSamplesWithAnchorResponse create_Func_void_StateOfMindSamplesWithAnchorResponse(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = ReactNativeHealthkit::Func_void_StateOfMindSamplesWithAnchorResponse::fromUnsafe(swiftClosureWrapper);
    return [swiftClosure = std::move(swiftClosure)](const StateOfMindSamplesWithAnchorResponse& result) mutable -> void {
      swiftClosure.call(result);
    };
  }
