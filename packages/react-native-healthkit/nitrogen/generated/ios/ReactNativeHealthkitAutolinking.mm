...
#import "ReactNativeHealthkit-Swift-Cxx-Umbrella.hpp"
#import <type_traits>
...
@implementation ReactNativeHealthkitAutolinking
...
+ (void) load {
  ...
  HybridObjectRegistry::registerHybridObjectConstructor(
    ...
    []() -> std::shared_ptr<HybridObject> {
      std::shared_ptr<HybridClinicalRecordsModuleSpec> hybridObject = ReactNativeHealthkit::ReactNativeHealthkitAutolinking::createClinicalRecordsModule();
      return hybridObject;
    }
  );
  HybridObjectRegistry::registerHybridObjectConstructor(
