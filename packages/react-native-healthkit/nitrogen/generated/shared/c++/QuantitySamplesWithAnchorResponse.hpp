...
namespace margelo::nitro::healthkit {
   ...
   */
  struct QuantitySamplesWithAnchorResponse final {
  public:
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::healthkit::QuantitySamplesWithAnchorResponse> final {
    static inline margelo::nitro::healthkit::QuantitySamplesWithAnchorResponse fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::healthkit::QuantitySamplesWithAnchorResponse(
        JSIConverter<std::vector<margelo::nitro::healthkit::QuantitySample>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "samples"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::healthkit::QuantitySamplesWithAnchorResponse& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "samples"), JSIConverter<std::vector<margelo::nitro::healthkit::QuantitySample>>::toJSI(runtime, arg.samples));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::vector<margelo::nitro::healthkit::QuantitySample>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "samples")))) return false;
