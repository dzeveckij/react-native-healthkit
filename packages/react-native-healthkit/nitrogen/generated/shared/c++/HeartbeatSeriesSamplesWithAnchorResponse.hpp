...
namespace margelo::nitro::healthkit {
   ...
   */
  struct HeartbeatSeriesSamplesWithAnchorResponse final {
  public:
  ...
  public:
    friend bool operator==(const HeartbeatSeriesSamplesWithAnchorResponse& lhs, const HeartbeatSeriesSamplesWithAnchorResponse& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::healthkit::HeartbeatSeriesSamplesWithAnchorResponse> final {
    static inline margelo::nitro::healthkit::HeartbeatSeriesSamplesWithAnchorResponse fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::healthkit::HeartbeatSeriesSamplesWithAnchorResponse(
        JSIConverter<std::vector<margelo::nitro::healthkit::HeartbeatSeriesSample>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "samples"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::healthkit::HeartbeatSeriesSamplesWithAnchorResponse& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "samples"), JSIConverter<std::vector<margelo::nitro::healthkit::HeartbeatSeriesSample>>::toJSI(runtime, arg.samples));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::vector<margelo::nitro::healthkit::HeartbeatSeriesSample>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "samples")))) return false;
